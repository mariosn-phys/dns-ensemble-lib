function [ICvkron,ICvDvkron,ICgkron,ICggkron,ICvCv,ICvIDELv,ICg,ICgCg,S_mf,S_mp,Sol_m,kkm,llm]=parsolvers(g,h)

%%% Mean flow and v,g solver matrices with timestep of fraction h

global N NX MZ D2 D2F k l D4 ksolv msolv Nksolv Nmsolv
  ...
  for ii=ksolv
    ...
    ICvIDELv(:,:,ii,kk)=ICv*IDEL;
          ...
          ICvkron=spalloc(N*Nksolv*Nmsolv,N*Nksolv*Nmsolv,N*N*Nksolv*Nmsolv);
          ICvDvkron=ICvkron;
          ICgkron=ICvkron;
          ICggkron=ICvkron;
          kkm=spalloc(N*Nksolv*Nmsolv,N*Nksolv*Nmsolv,N*Nksolv*Nmsolv);
          llm=kkm;
...
parfor ii=ksolv 
    ...
    for jk=[msolv(2:end)  MZ-flip(msolv(2:end))+2]
    ...
    ei=zeros(Nksolv,1);ei(ii)=1;
    
    IM=spdiags(ei,0,Nksolv,Nksolv);
