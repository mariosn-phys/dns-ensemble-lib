function [adv_v,adv_g] = advect_NL_dtm(up,vp,wp,gp,u3d,v3d,w3d,g3d)
    ...
    %---------------------------------
    %v advection terms 
    ad_u=up.*dxdup+vp.*dydup+wp.*dzdup+u3d;
    ad_v=up.*dxdvp+vp.*dydvp+wp.*dzdvp+v3d;
    ad_w=up.*dxdwp+vp.*dydwp+wp.*dzdwp+w3d;
