...
%%% !!!!!!!!!!!!
field_path = 'Data/Re1500_n61_alpha_ens/'  %% save and restart file path
...
Ti=335; % Initial Time (should match time on restart file name)
Tf=350; % Final Time
T=Ti:dt:Tf; 
NT=length(T);
...
Fnn = 1:5; % List of ensemble members
tsav=100; % interval of saves
